                    ...
                    <div class="flex items-center justify-between gap-3">
                        ...
                        <div class="flex flex-col items-end gap-1 text-xs">
                            ...
                            @elseif ($notification->status === 'failed')
                                <span class="inline-flex items-center rounded-md bg-red-100 px-2 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-100">
                                    {{ __('Failed') }}
                                </span>
                                ...
                                @endif
                            @else
                                <span class="inline-flex items-center rounded-md bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-800 dark:bg-amber-900 dark:text-amber-100">
                                    {{ __('Pending') }}
                                </span>
                            @endif
                            <span class="text-zinc-500 dark:text-zinc-400">
