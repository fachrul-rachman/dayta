<div class="flex flex-1 flex-col gap-4 rounded-xl">
    <div class="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="grid grid-cols-2 gap-2 md:grid-cols-3 md:items-end">
                ...
                <div class="flex items-end">
                    <button
                        type="button"
                        wire:click="$refresh"
                        class="mt-1 inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-400"
                    >
                        {{ __('Apply') }}
                    </button>
                </div>
        ...
        <div class="mt-3 grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <x-dashboard.card title="Division Flags" :value="$flagsCount" :variant="$flagsCount > 0 ? 'danger' : 'default'"></x-dashboard.card>
        </div>
        <div class="mt-4 grid gap-4 md:grid-cols-2">
            <div class="flex flex-col items-center" wire:ignore>
                ...
                ></canvas>
                <p class="mt-2 text-xs text-zinc-500 dark:text-zinc-400 text-center">
                    {{ __('Submitted vs not submitted for the selected period (distinct reporting users).') }}
                </p>
                <div class="mt-1 flex gap-3 text-xs text-zinc-500 dark:text-zinc-400">
            ...
            <div class="flex flex-col items-center" wire:ignore>
                ...
                <div class="mt-1 flex flex-wrap justify-center gap-3 text-xs text-zinc-500 dark:text-zinc-400">
            ...
            <div class="mt-4 border-t border-zinc-200 pt-3 dark:border-zinc-700">
                ...
                <div class="mt-2 flex flex-col gap-2 max-h-56 overflow-y-auto">
                    @foreach ($summaryHistory as $item)
                        <details class="group rounded-lg bg-zinc-50 p-2 dark:bg-zinc-800" x-data>
